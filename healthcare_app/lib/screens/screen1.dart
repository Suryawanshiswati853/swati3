...
import 'package:healthcare_app/screens/screen2.dart';
...
class _Screen1State extends State<Screen1> {
  ...
  Widget build(BuildContext context) {
    ...
    final newheight=MediaQuery.of(context).size.height*0.15;
    ...
    child:   Column(
      ...
      children: [
        ...
        Center(
      child:  Image.asset('assets/female_doctor.png',width: imagewidth,height: Imageheight,)),
        SizedBox(
          height: newheight2,
        ),
         const Padding(
