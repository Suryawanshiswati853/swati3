...
class ActivityStatusPage extends StatefulWidget {
  ...
  String playerid;
  ActivityStatusPage(this.playerid, this.userName);
  @override
  State<ActivityStatusPage> createState() =>
      _ActivityStatusPageState(this.playerid, this.userName);
}
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SearchDocStatus(this.playerid, this.userName),
                  ),
                );
              },
            ),
            ...
            child: ListTile(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PaymentStatusExecution(this.userName),
                  ),
                );
              },
            ),
