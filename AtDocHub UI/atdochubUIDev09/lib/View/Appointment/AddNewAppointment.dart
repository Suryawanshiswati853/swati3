...
class AddAppointment extends StatefulWidget {
  ...
  @override
  _AddAppointmentState createState() => _AddAppointmentState(this.playerid,this.userName);
}
...
class _AddAppointmentState extends State<AddAppointment> {
  ...
  late String datainput;
  String playerid;
  _AddAppointmentState(this.playerid,this.userName);
