...
class AppointmentPageFE extends StatefulWidget {
  ...
  AppointmentPageFE(this.playerid, this.userName);

  // final TextEditingController mycontroller = TextEditingController();
  @override
  State<AppointmentPageFE> createState() =>
      _AppointmentPageFEState(this.playerid, this.userName);
}
            ...
            Navigator.of(context).pushAndRemoveUntil(
                MaterialPageRoute(
                    builder: (BuildContext context) =>
                        AddAppointment(this.playerid, this.userName)),
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
              ...
              onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                  builder: (BuildContext context) =>
                      DocumentPage(this.playerid, this.userName)))),
        ),
...
//),
  ...
  Future searchAptDate(String query) async {
    final apmnt = await AppointmentController.aptDate(query);
    print("========" + '$apmnt');
