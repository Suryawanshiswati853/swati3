...
class DocumentsDetails extends StatefulWidget {
  ...
  DocumentsDetails(this.docId, this.playerid, this.userName);

  @override
  _DocumentsDetailsState createState() =>
      _DocumentsDetailsState(this.docId, this.playerid, this.userName);
}
          ...
          child: Center(
            child: FutureBuilder<Document>(
              ...
              builder: (context, snapshot) {
                ...
                print('CreatedBY Value : ${createdBY}');
                if (snapshot.hasData) {
