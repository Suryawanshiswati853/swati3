...
class ResetPassword extends StatefulWidget {
  ...
  ResetPassword(this.email, this.playerId);

  @override
  ResetPasswordState createState() => ResetPasswordState(this.email, playerId);
}
...
class ResetPasswordState extends State<ResetPassword> {
  ...
  ResetPasswordState(this.email, this.playerId);
