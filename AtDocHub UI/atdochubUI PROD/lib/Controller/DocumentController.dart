...
import '../Exceptions/ErrorHandler.dart';
...
class DocumentController {
  ...
  static FutureOr<Iterable<Document>> fetchDocuments(String title) async {
    final response = await http
        .get(Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/document'));
...
//call for list of documents
  ...
  static Future<List<Document>> agreementEnd() async {
    ...
    final url = Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/document/notification/');
  ...
  static Future<List<Appointment>> aptDate() async {
    final url = Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/appointment/aptdate?aptdate');
...
//call for search list bar
  ...
  static Future<Document> fetchDocumentsByID(docId) async {
    ...
    final response = await http.get(Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/document/find/${docId}'));
    //print(fromJson(json)).toList());
    if (response.statusCode == 200) {
      //final parsed = json.decode(response.body).cast<Map<String, dynamic>>();
      //log(parsed);
  ...
  static Future<List<Document>> getdocs(String query) async {
    // final url = Uri.parse('http://3.108.194.111 :8080/Atdochub-3/document/');
    final url = Uri.parse(
        // 'http://13.233.206.251:8088/AtdochubJ-3/document/'
        'http://13.233.206.251:8088/AtdochubJ-3/document/');
    final response = await http.get(url);
  ...
  static Future<List<Document>> getdatedocs(String query) async {
    ...
    final url = Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/document/findbystartdate?startdate=${query}');
    final response = await http.get(url);
  ...
  static Future<List<Document>> getenddatedocs(String query) async {
    ...
    final url = Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/document/findbyenddate?enddate=$query');
  ...
  static Future<List<Document>> getUserSuggestions(String query) async {
    // final url = Uri.parse('http://3.108.194.111 :8080/Atdochub-3/document/');
    final url = Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/document/');
    final response = await http.get(url);
  ...
  static Future checkDate(String stDate) async {
    ...
    final response = await http.get(Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/document/findbystartdate?startdate=2022-06-23'));
    // +
...
Future<Document> createDocument(
  ...
  final response = await http.post(
      Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/document/register'),
      headers: {
...
Future<Document> fetchDocument(docId) async {
  ...
  //   Uri.parse('http://13.233.206.251:8088/Atdochub-3/document/find/125'),

  final response = await http.get(
    Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/document/find/$docId'),
  );
...
Future<Document> updateDocument(
  ...
  //   Uri.parse('http://13.233.206.251:8088/Atdochub-3/document/update'),

  final response = await http.put(
    Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/document/update'),
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
    },
    body: jsonEncode(<String, dynamic>{
