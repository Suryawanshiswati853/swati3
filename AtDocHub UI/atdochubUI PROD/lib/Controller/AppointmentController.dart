...
class AppointmentController {
  ...
  static Future<Appointment> fetchAppointmentsById(aptId) async {
    final response = await http.get(
      Uri.parse(
          'http://13.233.206.251:8088/AtdochubJ-3/appointment/find/${aptId}'),
    );
  ...
  Future<Appointment> fetchAppointmentsByTitle(String aptTitle) async {
    final response = await http.get(
      Uri.parse(
          'http://13.233.206.251:8088/AtdochubJ-3/appointment/findbydocumenttitle/${aptTitle}'),
    );
  ...
  static Future<List<Appointment>> weeklyNotification() async {
    final url = Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/appointment/notification/');
    final response = await http.get(url);
    if (response.statusCode == 200) {
      final parsed = json.decode(response.body).cast<Map<String, dynamic>>();
  ...
  static Future<List<Appointment>> getAptList(String query) async {
    // final url = Uri.parse('http://192.168.0.134:8080/AtdochubJ-3/appointment/');
    final url =
        Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/appointment/');
    final response = await http.get(url);
  ...
  static Future<List<Appointment>> aptDate(String query) async {
    ...
    final url = Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/appointment/aptdate?aptdate=$query');
    final response = await http.get(url);
  ...
  static Future<List<Appointment>> fetchSearchAppointmentList() async {
    ...
    final response = await http
        .get(Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/appointment/'));
    //print(fromJson(json)).toList());
    if (response.statusCode == 200) {
      final parsed = json.decode(response.body).cast<Map<String, dynamic>>();
  ...
  static Future<List<Appointment>> fetchAptByTodays() async {
    ...
    final response = await http.get(
        Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/appointment/todays'
            // 'http://13.233.206.251:8088/AtdochubJ-3/appointment/todays'
            ));
    //print(fromJson(json)).toList());
    if (response.statusCode == 200) {
      final parsed = json.decode(response.body).cast<Map<String, dynamic>>();
...
// list of tommarrows appointment rest api
  ...
  static Future<List<Appointment>> fetchAptByTommorow() async {
    final response = await http.get(Uri.parse(
        'http://13.233.206.251:8088/AtdochubJ-3/appointment/tommorows'));
    //print(fromJson(json)).toList());
    if (response.statusCode == 200) {
      final parsed = json.decode(response.body).cast<Map<String, dynamic>>();
...
Future<Appointment> createAppointment(
  ...
  final response = await http.put(
      ...
      Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/appointment/register'

          // 'http://13.233.206.251:8088/AtdochubJ-3/appointment/register'
          ),
      headers: {
...
Future<Appointment> updateAppointment(
  ...
  final http.Response response = await http.put(
    ...
    Uri.parse('http://13.233.206.251:8088/AtdochubJ-3/appointment/update'),
    headers: {
      'Content-Type': 'application/json; charset=UTF-8',
    },
    body: jsonEncode(<String, dynamic>{
