...
class PaymentDetailEditPage extends StatefulWidget {
  ...
  PaymentDetailEditPage(this.aptId, this.dTitle, this.tNo, this.staffid);
  @override
  _State createState() =>
      _State(this.aptId, this.dTitle, this.tNo, this.staffid);
}

class _State extends State<PaymentDetailEditPage> {
  final did = null;
  var Mode = ["Online", "Cash", "Cheque"];
        ...
        leading: IconButton(
            ...
            onPressed: () => Navigator.of(context).push(MaterialPageRoute(
                builder: (BuildContext context) =>
                    PaymentStatusDetailsPage(aptId, dTitle, tNo, staffid)))),
      ),
