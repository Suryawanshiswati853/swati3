...
class PaymentStatusDetailsPage extends StatefulWidget {
  ...
  final String tNo;
  final int staffid;
  PaymentStatusDetailsPage(this.aptId, this.dTitle, this.tNo, this.staffid);

  @override
  _PaymentStatusDetailsState createState() => _PaymentStatusDetailsState(
      this.aptId, this.dTitle, this.tNo, this.staffid);
}
...
class _PaymentStatusDetailsState extends State<PaymentStatusDetailsPage> {
  ...
  _PaymentStatusDetailsState(this.aptId, this.dTitle, this.tNo, this.staffid);
