...
class LoginController {
  ...
  static Future<List<UserLogin>> login(
    ...
    // try {
    final response = await http.get(Uri.parse(
        'http:3.108.194.111:8080/AtdochubJ-3/user/login?useremail=${email}&userpassword=${password}&playerid=6589656adadas46464adsd'));
    //'http://3.108.194.111:8080/AtdochubJ-3/user/login?useremail=${email}&userpassword=${password}&playerId="4fe42350-9806-40dd-8c26-42eff0cdfbcb"'));
    // print('email+++ ${email}');
    // print('password ${password}');
    //print(fromJson(json)).toList());
