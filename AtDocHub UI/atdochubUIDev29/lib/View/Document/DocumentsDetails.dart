          ...
          child: Center(
            child: FutureBuilder<Document>(
              ...
              builder: (context, snapshot) {
                if (snapshot.hasData) {
                  final String createdBY = snapshot.data!.createdBy;
                  print('DOCD:${createdBY}');
                ...
                print('Username DOCDetails : ${this.userName}');
                //    print('Username DOCDetails : ${this.createdBY}');
