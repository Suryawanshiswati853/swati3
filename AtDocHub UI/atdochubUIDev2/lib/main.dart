...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> initPlatformState() async {
    ...
    OneSignal.shared.setNotificationOpenedHandler(
      ...
      // var id2 = await result.notification.additionalData!["Aptid"];

      final int docid = int.parse(id1).toInt();
      // final int aptid = int.parse(id2).toInt();
      // print('id from notification...... $docid');
      navigatorKey.currentState!.push(MaterialPageRoute(
          builder: (context) => DocumentsDetails(docid, usrname)));
      // navigatorKey.currentState!.push(MaterialPageRoute(
      //     builder: (context) => AppointmentDetails(usrname, aptid)));
    });
  ...
  Future<void> initPlatformStateApt() async {
    String usrname = SharedPrefService.pref.getString('username').toString();
