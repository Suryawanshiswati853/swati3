...
//                 builder: (BuildContext context) => ActivityStatusPage(this.playerid)))),
//       ),
//       body: SafeArea(
...
//                           aptId, title, token, docId, userId)));
//                 },
//               ),
//             ),
//           ]),
            ...
            Container(
              ...
              child: TypeAheadField<Appointment>(
                ...
                onSuggestionSelected: (Appointment suggestion) {
                  ...
                  //this.texttitle.text = user.aptTime;
                  //  this.texttitle.text = user.partyName;
                  final int aptId = user.aptId;
                  final int userId = user.staffId;
                  final int docId = user.docId;
                  final String title = user.docTitle;
                  final int token = user.tokenNo;

                  this.texttitle.text = user.docTitle;
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => PaymentStatusDetailsPage(
                          aptId, title, token, docId, userId, user.userName)));
                },
              ),
            ),
          ]),
