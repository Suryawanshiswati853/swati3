...
class PaymentStatusDetailsPage extends StatefulWidget {
  ...
  PaymentStatusDetailsPage(this.aptId, this.dTitle, this.tNo, this.docid,
...
class _PaymentStatusDetailsState extends State<PaymentStatusDetailsPage> {
  ...
  _PaymentStatusDetailsState(this.aptId, this.dTitle, this.tNo, this.docid,
      this.staffid, this.userName);
