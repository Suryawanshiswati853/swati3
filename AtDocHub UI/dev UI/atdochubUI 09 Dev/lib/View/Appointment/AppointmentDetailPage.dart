...
class AppointmentDetails extends StatefulWidget {
  ...
  AppointmentDetails(this.userName, this.aptId, this.staff_Id, this.docID,
...
class _AppointmentDetailsState extends State<AppointmentDetails> {
  //_AppointmentDetailsState(this.userName);
  ...
  _AppointmentDetailsState(this.userName, this.aptId, this.staff_Id, this.docID,
      this.dTitle, this.tNo, this.aptExecutive);
