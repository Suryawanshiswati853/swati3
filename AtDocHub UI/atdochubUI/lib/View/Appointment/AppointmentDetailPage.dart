...
class AppointmentDetails extends StatefulWidget {
  ...
  AppointmentDetails(this.aptId, this.docId, this.staff_Id, this.doctitle,
...
class _AppointmentDetailsState extends State<AppointmentDetails> {
  ...
  _AppointmentDetailsState(this.aptId, this.docId, this.staff_Id, this.doctitle,
      this.docToken, this.aptExecutive);
                    ...
                    child: Container(
                      ...
                      child: SelectionArea(
                        child: Column(
                            ...
                            children: [
                              Text('Document Title: ${this.doctitle}',
                                  style: const TextStyle(fontSize: 15.0)),
                              Text("Token No :${this.docToken} ",
                                  style: const TextStyle(fontSize: 15.0)),
